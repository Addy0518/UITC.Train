...
<template>
  <div class="flex flex-col w-full p-6" v-if="allCoupons">
    ...
    <div class="bg-page-bg rounded-card border border-border-soft overflow-hidden">
      <!-- #region  欄位標頭-->
      <div
        class="grid grid-cols-[90px_1.4fr_1fr_0.9fr_1fr_1.4fr_0.8fr_110px] px-5 py-2.5 bg-surface-muted border-b border-border-soft"
      >
      ...
      <template v-if="isFiltering">
        <div
          v-for="n in 6"
          :key="n"
          class="grid grid-cols-[90px_1.4fr_1fr_0.9fr_1fr_1.4fr_0.8fr_110px] px-5 py-4 border-b border-border-soft gap-4 items-center"
        >
      ...
      <template v-else>
        ...
        <div
          ...
          :key="coupon.couponId"
          class="grid grid-cols-[90px_1.4fr_1fr_0.9fr_1fr_1.4fr_0.8fr_110px] px-5 py-4 border-b border-border-soft items-center hover:bg-surface-muted"
        >
